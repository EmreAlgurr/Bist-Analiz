...
public final class BistTum {
    ...
    public static final List<String> SEMBOLLER = List.of(
        ...
        "ECZYT.IS","EDIP.IS","EGEPO.IS","EGPRO.IS",
        ...
        "SMART.IS","SNICA.IS","SODSN.IS","SOKE.IS",
        ...
        "DERIM.IS","DESPC.IS","DITAS.IS","DMRGD.IS",
        "DNISI.IS","DURDO.IS",
        ...
        "HLGYO.IS","HUBVC.IS","IDEAS.IS","IDGYO.IS",
        ...
        "VKFYO.IS","YAYLA.IS","YESIL.IS","YYAPI.IS",
        "ZEDUR.IS","ZRGYO.IS"
